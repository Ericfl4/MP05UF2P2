...
/*
   H- 1. Fes les modificacions necessàries perquè aquest projecte funcioni correctament fent servir Maven.

   H- 2. Puja el projecte a GitHub i activa les accions necessàries perquè, en fer commit, s'executin els jocs de proves
