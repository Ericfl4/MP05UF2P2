...
public class HashTable {
    ...
    private HashEntry buscarEntry(String key) {
    ...
    private void insertarEntry(HashEntry hashEntry, int hash) {
        HashEntry temp = entries[hash];
    ...
    public void put(String key, String value) {
        ...
        if (entries[hash] == null) {
            ...
            HashEntry temp = buscarEntry(key);
            if (temp != null) {
                temp.value = value;
            } else {
                insertarEntry(hashEntry, hash);
            }
        }
    }
    /**
    ...
    public String get(String key) {
        HashEntry entry = buscarEntry(key);
        if (entry!=null){
            return entry.value;
        } else {
            return null;
    ...
    public void drop(String key) {
        int hash = getHash(key);
        if(entries[hash] != null) {
            HashEntry entryToDelete = buscarEntry(key);
            if(entryToDelete != null) {
                eliminarEntry(entryToDelete, hash);
                ITEMS--;
            }
        }
    }
